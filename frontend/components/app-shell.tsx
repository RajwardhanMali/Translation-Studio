...
const NAV_ITEMS = [
  {
    ...
    label: "Documents",
    icon: FolderOpen,
    description: "Library and progress",
  },
  {
    href: "/upload",
    label: "Upload",
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-transparent">
      ...
      <motion.aside
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-30 flex flex-col border-r border-sidebar-border bg-sidebar/96 transition-[width,transform] duration-300 lg:translate-x-0",
      ...
      >
        ...
        <nav className="flex-1 space-y-2 p-4">
          <p
            className={cn(
              "px-3 pb-2 text-[10px] font-semibold uppercase tracking-[0.24em] text-sidebar-muted-foreground",
                ...
                <div
                  className={cn(
                    ...
                    isActive
                      ...
                      : "bg-background/70 text-sidebar-muted-foreground",
                  )}
                >
